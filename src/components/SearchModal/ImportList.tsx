...
import { TokenList } from '@crystalswap/token-lists'
            ...
            <RowBetween>
              <RowFixed>
                ...
                <AutoColumn gap="sm" style={{ marginLeft: '20px' }}>
                  ...
                  <ExternalLink href={`https://lists.crystalswap.org/token-list?url=${listURL}`}>
          ...
          <Card style={{ backgroundColor: transparentize(0.8, theme.red1) }}>
            ...
            <AutoColumn style={{ textAlign: 'center', gap: '16px', marginBottom: '12px' }}>
              <TYPE.body fontWeight={500} color={theme.red1}>
                Anyone can create a list, including creating fake versions of existing lists and lists that falsely
