...
const CODE_LINK = 'https://github.crystalswap.org'
...
export default function Menu() {
  ...
  return (
    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          <MenuItem href="https://crystalswap.org/">
            <Info size={14} />
            <div>About</div>
          </MenuItem>
          <MenuItem href="https://docs.crystalswap.org/">
            <BookOpen size={14} />
            <div>Docs</div>
          </MenuItem>
          ...
          <MenuItem href="https://discord.crystalswap.org/">
            <MessageCircle size={14} />
            <div>Discord</div>
          </MenuItem>
          <MenuItem href="https://info.crystalswap.org/">
            <PieChart size={14} />
            <div>Analytics</div>
          </MenuItem>
        </MenuFlyout>
