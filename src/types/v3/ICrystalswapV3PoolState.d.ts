...
interface ICrystalswapV3PoolStateInterface extends ethers.utils.Interface {
  functions: {
...
export class ICrystalswapV3PoolState extends Contract {
  ...
  interface: ICrystalswapV3PoolStateInterface;
