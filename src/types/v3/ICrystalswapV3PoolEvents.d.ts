...
interface ICrystalswapV3PoolEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class ICrystalswapV3PoolEvents extends Contract {
  ...
  interface: ICrystalswapV3PoolEventsInterface;
