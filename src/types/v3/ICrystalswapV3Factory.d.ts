...
interface ICrystalswapV3FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ICrystalswapV3Factory extends Contract {
  ...
  interface: ICrystalswapV3FactoryInterface;
