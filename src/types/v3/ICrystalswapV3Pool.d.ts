...
interface ICrystalswapV3PoolInterface extends ethers.utils.Interface {
  functions: {
...
export class ICrystalswapV3Pool extends Contract {
  ...
  interface: ICrystalswapV3PoolInterface;
