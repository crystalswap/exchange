...
interface CrystalswapV3FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class CrystalswapV3Factory extends Contract {
  ...
  interface: CrystalswapV3FactoryInterface;
