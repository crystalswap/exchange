...
interface ICrystalswapV3PoolActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class ICrystalswapV3PoolActions extends Contract {
  ...
  interface: ICrystalswapV3PoolActionsInterface;
