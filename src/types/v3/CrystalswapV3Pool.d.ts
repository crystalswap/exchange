...
interface CrystalswapV3PoolInterface extends ethers.utils.Interface {
  functions: {
...
export class CrystalswapV3Pool extends Contract {
  ...
  interface: CrystalswapV3PoolInterface;
