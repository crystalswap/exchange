...
interface SocksInterface extends ethers.utils.Interface {
  functions: {
...
export class Socks extends Contract {
  ...
  callStatic: {
    ...
    "mint(address)"(_to: string, overrides?: CallOverrides): Promise<boolean>;
