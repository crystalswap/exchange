...
import { Currency, TokenAmount, ETHER, currencyEquals } from '@crystalswap/sdk-core'
import { WETH9 } from '@crystalswap/sdk-core'
...
import { FeeAmount, NonfungiblePositionManager } from '@crystalswap/v3-sdk'
              ...
              <>
                    ...
                    <AutoColumn gap="md">
                      ...
                      >
                        ...
                        <TYPE.body
                          ...
                          textAlign="center"
                        >
                          You are the first liquidity provider for this Crystalswap V3 pool.
                        </TYPE.body>
                ...
                <DynamicSection gap="md" disabled={!feeAmount || invalidPool || (noLiquidity && !startPriceTypedValue)}>
                  ...
                  <TYPE.main fontSize={14} fontWeight={400} style={{ marginBottom: '.5rem', lineHeight: '125%' }}>
                    ...
                    <ExternalLink
                      href={'https://docs.crystalswap.org/concepts/introduction/liquidity-user-guide'}
                      style={{ fontSize: '14px' }}
                    >
