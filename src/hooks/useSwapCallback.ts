...
import { Router, Trade as V2Trade } from '@crystalswap/v2-sdk'
import { SwapRouter, Trade as V3Trade } from '@crystalswap/v3-sdk'
import { ChainId, Percent, TradeType } from '@crystalswap/sdk-core'
                ...
                return library
                  ...
                  .catch((callError) => {
                    ...
                    switch (callError.reason) {
                      case 'CrystalswapV2Router: EXPIRED':
                        errorMessage =
                        ...
                        break
                      case 'CrystalswapV2Router: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'CrystalswapV2Router: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
                          'This transaction will not succeed either due to price movement or fee on transfer. Try increasing your slippage tolerance.'
                        break
                      case 'CrystalswapV2: TRANSFER_FAILED':
                        errorMessage = 'The token could not be transferred. There may be an issue with the token.'
                        break
                      case 'CrystalswapV2: K':
                        errorMessage =
                          'The Crystalswap invariant x*y=k was not satisfied by the swap. This usually means one of the tokens you are swapping incorporates custom behavior on transfer.'
                        break
                      default:
                        return { call }
                    }
