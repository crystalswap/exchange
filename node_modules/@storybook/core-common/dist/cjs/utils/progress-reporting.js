...
exports.useProgressReporting = void 0;

var _printDuration = require("./print-duration");

var useProgressReporting = async function (router, startTime, options) {
  var _options$cache;
  ...
  var handler = function (newValue, message, arg3) {
    ...
    if (value === 1) {
      ...
      if (!progress.message) {
        progress.message = `Completed in ${(0, _printDuration.printDuration)(startTime)}.`;
      }
    }
...
exports.useProgressReporting = useProgressReporting;