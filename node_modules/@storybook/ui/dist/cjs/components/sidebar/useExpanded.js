...
var useExpanded = function useExpanded(_ref2) {
  ...
  (0, _react.useEffect)(function () {
    var menuElement = _global.document.getElementById('storybook-explorer-menu'); // Even though we ignore repeated events, use throttle because IE doesn't support event.repeat.
