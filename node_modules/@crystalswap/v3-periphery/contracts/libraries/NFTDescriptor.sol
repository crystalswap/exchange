...
import '@crystalswap/v3-core/contracts/libraries/TickMath.sol';
import '@crystalswap/v3-core/contracts/libraries/BitMath.sol';
import '@crystalswap/v3-core/contracts/libraries/FullMath.sol';
...
library NFTDescriptor {
    ...
    function generateDescriptionPartOne(
        ...
        return
            string(
                abi.encodePacked(
                    'This NFT represents a liquidity position in a Crystalswap V3 ',
                    quoteTokenSymbol,
                    '-',
                    baseTokenSymbol,
                    ' pool. ',
