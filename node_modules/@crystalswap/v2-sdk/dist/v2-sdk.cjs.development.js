...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new sdkCore.Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'UNI-V2', 'Crystalswap V2');
...
var ZERO_HEX = '0x0';
/**
 * Represents the Crystalswap V2 Router, and has static methods for helping execute trades.
 */
