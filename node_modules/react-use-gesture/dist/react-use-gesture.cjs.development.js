...
function (_DistanceAngleRecogni) {
  ...
  function PinchWheelRecognizer(controller, args) {
    ...
    _this.onWheel = function (event) {
      ...
      if (!_this.controller.config.passiveEvents) event.preventDefault();else console.warn('To support zoom on trackpads, try using the `domTarget` option and `config.event.passive` set to `false`. This message will only appear in development mode.');
