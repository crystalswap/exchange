import { StateKey, StateObject, SharedGestureState, GestureKey, Fn, GestureFlag, ReactEventHandlers, GestureConfig, HandlerKey, GestureHandlersPartial } from '../types';
...
export default class GestureController {
     ...
     */
    updateState: (sharedState: Partial<SharedGestureState> | null, gestureState: Partial<import("../types").Coordinates & import("../types").CommonGestureState> | Partial<import("../types").DistanceAngle & import("../types").CommonGestureState>, stateKey: "drag" | "pinch" | "move" | "scroll" | "wheel") => void;
